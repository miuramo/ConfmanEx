...
class PaperController extends Controller
{
    ...
    public function create()
    {
        ...
        $kakunin = Confirm::where('grp', 1)->where('valid', 1)->select('name', 'mes')->get()->sortBy('name')->pluck('mes', 'name')->toArray();
        $mailkakunin = Confirm::where('grp', 2)->where('valid', 1)->select('name', 'mes')->get()->sortBy('name')->pluck('mes', 'name')->toArray();
