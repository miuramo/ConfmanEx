        ...
        @else
            <div class="mt-0 bg-blue-100 p-3 rounded dark:bg-blue-900">
                <input id="id_regist_searchbox" type="text" wire:model.live.debounce.500ms="search"
                    wire:keydown.escape="resetSearch" placeholder="氏名・メール等で検索" size="25" x-init="$el.focus()"
                    class="p-1" />
                            ...
                            <td class="px-2 bg-slate-200">
                                ...
                                @else
                                    <button x-data
                                        ...
                                        class="px-2 py-1 bg-cyan-500 text-white rounded hover:bg-cyan-600 dark:bg-cyan-700 dark:hover:bg-cyan-800">
                                        追加
                                    </button>
                                @endif
                            </td>
                ...
                <button wire:click="close_invite"
                    class="mt-2 px-3 py-1 bg-gray-500 text-white rounded hover:bg-gray-600 dark:bg-gray-700 dark:hover:bg-gray-800">
                    キャンセル（検索画面をとじる）
                </button>
            </div>
        @endif
