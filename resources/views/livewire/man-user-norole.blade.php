<div>
    ...
    <div class="mt-4">
        <input type="button" wire:click="softdelete_norole_nopaper_users" class="bg-orange-300 text-white text-sm hover:bg-orange-600 p-2 rounded-lg" value="役職なし＆発表なしのユーザをソフトデリート"/>
