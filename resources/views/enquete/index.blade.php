    ...
    <div class="py-4 px-6  dark:text-gray-400">
        @foreach ($enqs as $enq)
            ...
            <div class="my-2">
                ...
                <x-element.linkbutton2 href="{{ route('enq.config', ['enq' => $enq->id]) }}" color="slate"
                    size="sm">
                    受付設定
            ...
            <div class="text-sm ml-0 text-gray-400">
                ...
                <span class="mx-1"></span>
                <x-element.deletebutton action="{{ route('enq.destroy', ['enq' => $enq->id]) }}" size="sm"
                    confirm="アンケートを論理削除してよいですか？" align="right">
                    削除
