@php
    ...
    if (!isset($scheduledUpdateTargetType)) {
        $eloModelName = 'App\\Models\\' . \Illuminate\Support\Str::studly(\Illuminate\Support\Str::singular($tableName));
        $scheduledUpdateTargetType = class_exists($eloModelName) ? $eloModelName : null;
    }
@endphp
