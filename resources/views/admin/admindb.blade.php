<x-app-layout>
    ...
    <div class="px-4">
        ...
        <x-element.h1>権限・Roleの管理  <span class="ml-10 text-blue-600 font-bold">凡例：</span><span class="mx-1 bg-slate-500 text-white rounded-md py-1 px-2"><sub>（RoleID）</sub>Role名 n=人数</span></x-element.h1>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
