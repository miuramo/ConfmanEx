    ...
    <div class="mx-2 my-5 flex-grow dark:text-gray-300">
        ...
        @php
            $a = [
                ...
                'review_score_accept(catid,"name",">=",score)' => '上記のうち、catidで採択されている論文',
        ...
        @php
            $u = [
                ...
                'reg_user_valid( valid=1 )' => '参加登録ユーザ全員 (引数を「0」にすると無効ユーザのみ)',
                'reg_user_noenqans("name")' => 'アンケート項目「name」に未回答の参加登録ユーザ',
            ];
        @endphp
        <table class="border-cyan-200 border-2">
            @foreach ($u as $k => $v)
